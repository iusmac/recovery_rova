...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -I/opt/Android_NDK_r24/usr/include',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '-fno-strict-aliasing',
 'CFLAGS_NODIST': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/opt/Android_NDK_r24/usr/include',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/opt/Android_NDK_r24/usr/include',
 'CONFIGURE_LDFLAGS': '-L/opt/Android_NDK_r24/usr/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/python' '--host=aarch64-linux-android' "
                "'--build=x86_64-linux-gnu' '--disable-ipv6' "
                "'--disable-test-modules' '--without-ensurepip' "
                "'--without-tcltk' 'build_alias=x86_64-linux-gnu' "
                "'host_alias=aarch64-linux-android' "
                "'CC=aarch64-linux-android-gcc' "
                "'CFLAGS=-I/opt/Android_NDK_r24/usr/include' "
                "'LDFLAGS=-L/opt/Android_NDK_r24/usr/lib' "
                "'CPPFLAGS=-I/opt/Android_NDK_r24/usr/include'",
 'CONFINCLUDEDIR': '/python/include',
 'CONFINCLUDEPY': '/python/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/jabba/programming/Recovery/test/newthings/Python-3.10.4/android/coverage.info',
 'COVERAGE_REPORT': '/home/jabba/programming/Recovery/test/newthings/Python-3.10.4/android/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include '
             '-I/opt/Android_NDK_r24/usr/include',
 'CXX': 'aarch64-linux-android-g++',
 'DESTDIRS': '/python /python/lib /python/lib/python3.10 '
             '/python/lib/python3.10/lib-dynload',
 'DESTLIB': '/python/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/python/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/python/include /python/include /python/include/python3.10 '
                   '/python/include/python3.10',
 'INCLUDEDIR': '/python/include',
 'INCLUDEPY': '/python/include/python3.10',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'aarch64-linux-android-gcc -shared -L/opt/Android_NDK_r24/usr/lib',
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/python/lib/python3.10',
 'LIBDIR': '/python/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 ...
 'LIBPL': '/python/lib/python3.10/config-3.10',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/python/lib/python3.10',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/jabba/programming/Recovery/test/newthings/Python-3.10.4/android '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/jabba/programming/Recovery/test/newthings/Python-3.10.4/android/`cat '
                     'pybuilddir.txt`:)../Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-I/opt/Android_NDK_r24/usr/include -std=c99 '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -I/opt/Android_NDK_r24/usr/include',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-I/opt/Android_NDK_r24/usr/include -std=c99 -Wextra '
                   '-Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers -Wstrict-prototypes '
                   '-Werror=implicit-function-declaration -fvisibility=hidden  '
                   '-I../Include/internal -IObjects -IInclude -IPython -I. '
                   '-I../Include -I/opt/Android_NDK_r24/usr/include '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/opt/Android_NDK_r24/usr/lib',
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include '
                '-I/opt/Android_NDK_r24/usr/include',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/opt/Android_NDK_r24/usr/lib',
 'PY_LDFLAGS_NODIST': '',
 ...
 'abs_builddir': '/home/jabba/programming/Recovery/test/newthings/Python-3.10.4/android',
 'abs_srcdir': '/home/jabba/programming/Recovery/test/newthings/Python-3.10.4/android/..',
